...
template <typename T> vector<vector<T>> vec2(int n, int m, int val) {return vector<vector<T>>(n,vector<T>(m,val));}
template <typename T> vector<vector<vector<T>>> vec3(int n, int m, int k, int val) {return vector<vector<vector<T>>>(n,vector<vector<T>>(m,vector<T>(k,val)));}
